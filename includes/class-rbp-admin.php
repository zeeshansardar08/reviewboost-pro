...
<tr valign="top">
	...
	public function render_coupon_logs_dashboard() {
		...
		// Analytics summary
		echo '<div class="rbp-logs-analytics" style="margin-bottom:20px;background:#f9f9f9;border:1px solid #e1e1e1;padding:12px 18px;display:flex;gap:32px;align-items:center;border-radius:8px;">';
	...
	public function render_upgrade_to_pro_page() {
		...
		<div class="wrap rbp-upgrade-to-pro">
			<div class="rbp-upgrade-container">
				...
				<a href="<?php echo esc_url($upgrade_url); ?>" target="_blank" class="rbp-btn rbp-btn-primary rbp-btn-hero"><?php esc_html_e('Upgrade Now','reviewboost-pro'); ?></a>
				<div class="rbp-faq">
